/** @param {NS} ns **/export async function main(ns) {
	...
	await ns.write(files[15],"/** @param {NS} ns **/export async function main(ns) {ns.tail();ns.kill('n00dleshack.js','home');var threads = (Math.floor(ns.getServerMaxRam('home')-11)/2.4);ns.run('n00dleshack.js',threads);}","w");
